...
public class LoggerConstants {
    ...
    public static final String REPO_ADD_STUDENT = "Repository used 'addStudent' with arg:'{}'" ;
    ...
    public static final String REPO_ADD_GROUP = "Repository used 'addGroup' with arg:'{}'" ;
    ...
    public static final String REPO_ADD_TEACHER = "Repository used 'addTeacher' with arg:'{}'" ;
    ...
    public static final String REPO_DELETE_SCHEDULES = "Repository used 'deleteSchedule' with on ID: '{}' and result: '{}'" ;
    public static final String REPO_GET_SCHEDULE_BY_UNIT = "Repository used 'getScheduleById'. Return Optional with state: '{}'" ;
